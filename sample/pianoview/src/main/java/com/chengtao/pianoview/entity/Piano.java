...
public class Piano {
    ...
    private void initPiano() {
        ...
        blackKeyHeight = blackDrawable.getIntrinsicHeight();
        whiteKeyWidth = whiteDrawable.getIntrinsicWidth();
        whiteKeyHeight = whiteDrawable.getIntrinsicHeight();
            ...
            switch (i){
                case 0:
                    ...
                    for (int j = 0; j < keys0.length; j++){
                        ...
                        keys0[j].setKeyDrawable(ContextCompat.getDrawable(context, R.drawable.black_piano_key));
                ...
                default:
                    ...
                    for (int j = 0; j < keys1.length; j++){
                        ...
                        keys1[j].setKeyDrawable(ContextCompat.getDrawable(context, R.drawable.black_piano_key));
            ...
            switch (i){
                case 0:
                    ...
                    for (int j = 0; j < keys0.length; j++){
                        ...
                        keys0[j].setPressed(false);
                        keys0[j].setKeyDrawable(ContextCompat.getDrawable(context, R.drawable.white_piano_key));
                ...
                case 8:
                    ...
                    for (int j = 0; j < keys1.length; j++){
                        ...
                        keys1[j].setPressed(false);
                        keys1[j].setKeyDrawable(ContextCompat.getDrawable(context, R.drawable.white_piano_key));
                ...
                default:
                    ...
                    for (int j = 0; j < keys2.length; j++){
                        ...
                        keys2[j].setKeyDrawable(ContextCompat.getDrawable(context, R.drawable.white_piano_key));
